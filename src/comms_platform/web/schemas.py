...
class SdxlGeneratePayload(BaseModel):
    ...
    guidance_scale: float = Field(default=float(os.getenv("SDXL_DEFAULT_GUIDANCE", "7.0")), ge=1.0, le=20.0)
    num_inference_steps: int = Field(default=int(os.getenv("SDXL_DEFAULT_STEPS", "20")), ge=5, le=75)
